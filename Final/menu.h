...
public:
	...
	/**
	 * Ordena os Must Points do mais perto á origem para o mais longe;
	 *
	 ...
	 *
	 * \return ss.str() string já transformada;
	 *
	 */
	template <typename T>
	...
	/**
	 *  Menu que contem todas as funçoes sobre a frota de camioes;
	 */
	void menuFrota()
	{
		int opcao;
	...
	/**
	 * Menu principal, dá acesso aos outros menus.
	 */
	void menu1()
	{
	int opcao;
	...
	/**
	 * Menu que contem todas as funçoes sobre Items;
	 */
	void menuItems()
	{
		Mapa<string> m;
 ...
 */
	...
	/**
	 * Menu onde é posivel visualizar o mapa atual;
	 */
	void menuMapa()
	{
		        Mapa<string> m;
			    ...
			    for (int i=0; i < grafo->vertexSet.size(); i++)
			    {
			    	...
			    	{
			    		string str=NumberToString(grafo->vertexSet[i]->adj[k].info);
